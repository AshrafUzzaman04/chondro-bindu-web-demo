      ...
      this.each(function () {
          ...
          if (!p && o) {
            ...
            switch (g) {
              ...
              case "pagination":
                (k = parseInt(i, 10)),
                  (l = a(
                    "." + b.paginationClass + " li." + b.currentClass + " a",
                    c
                  )
                    .attr("href")
                    .match("[^#/]+$")),
            ...
            h === "fade"
                  ...
                  ? d.animate(
                      ...
                      function () {
                        d.css({ left: -f }),
                          ...
                          d
                            .children(":eq(" + l + ")")
                            .css({ left: f, display: "none", zIndex: 0 }),
                          b.animationComplete(k + 1),
                          (p = !1);
                      }
                    )
              ...
              b.pagination &&
                (a(
                  "." + b.paginationClass + " li." + b.currentClass,
                  c
                ).removeClass(b.currentClass),
                a("." + b.paginationClass + " li:eq(" + k + ")", c).addClass(
                  b.currentClass
                ));
          }
        }
        ...
        var c = a(this),
          ...
          i =
            b.effect.indexOf(",") < 0
              ? b.effect
              : b.effect.replace(" ", "").split(",")[0],
          j =
            b.effect.indexOf(",") < 0
              ? i
              : b.effect.replace(" ", "").split(",")[1],
          k = 0,
          l = 0,
          m = 0,
          n = 0,
        ...
        b.bigTarget &&
          ...
          b.generateNextPrev &&
            (a("." + b.container, c).after(
              '<a href="#" class="' + b.prev + '">Prev</a>'
            ),
            a("." + b.prev, c).after(
              '<a href="#" class="' + b.next + '">Next</a>'
            )),
          ...
          a("." + b.paginationClass + " li:eq(" + h + ")", c).addClass(
            b.currentClass
          ),
